    ...
    <>
      ...
      {props.login ? (
        props.check ? (
          ...
          <div className="review-card">
            <p style={{ color: 'black' }}>
              You haven't successfully bought this product, please buy this
              product first to submit a comment or review .
            </p>
          </div>
        )
      ) : null}
      <div className="scroll-div1">
        <div className="scroll-object">
          <div className="r-row">
            {comments.length < 1 ? <h3>No comments</h3> : null}
