                        ...
                        {/* quantity adjustment experiment*/}
                                ...
                                <div id="div1">
                                    <form action="">
                                        <p className="q-btn">
                                            {/* value={"-"} */}
                                            <button className="qtyminus" onClick={()=>editQty(data[0], itemNum[data[0]]-=1)}>-</button>
                                            <input type="number" className="qty-int" name="qty"  value={itemNum[data[0]]} onChange={(e)=>editQty(data[0], parseInt(e.target.value))}/>
                                            {/* value={"+"} */}
                                            <button className="qtyplus" onClick={()=>editQty(data[0], itemNum[data[0]]+=1)}>+</button>
                                        </p>
                                    </form>
                                       </div>
