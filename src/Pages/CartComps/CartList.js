  ...
  const update = (key2, amt) =>{
    ...
    return(
      ...
      <div className="form-step form-step-active">
        ...
        <div className="scroll-div" id="style-4">
            <div className="scroll-object">
              ...
              <div className="cart-box" key={index}>
                <input type="checkbox" className="checkbox" onClick={(e)=>check(e, data[0], data[1])}/>
                    {/* <!-- img container --> */}
        ...
        <div className="">
          <a href={void(0)} className="cart-btn btn-next">NEXT</a>
        </div>
      </div>
      <div className="form-step">
        {/* <SelectOrder /> */}
        <SelectOrder data={select} totalamount={totalamount} t_data={data} setData={setData}/>
        <div className="btns-group">
          <a href={void(0)} className="prev-btn btn-prev">PREVIOUS</a>
          <a href={void(0)} className="next-btn btn-next">CHECKOUT</a>
        </div>
      </div>
      ...
      <div className="form-step">
        ...
        <div className="btn-group">
          <a href={void(0)} className="cart-btn btn-prev">PREVIOUS</a>
