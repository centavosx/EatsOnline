                    ...
                    <div lassName="needs-validation">
                        ...
                        <div className="my-1">
                            ...
                            <div className="advance-order">
                                <input id="advorder" name="aoao" type="radio" className="form-check-input" checked={props.chA} onClick={() => { props.setChA(true); }} />
                        ...
                        <div className="my-1">
                            ...
                            <div className="advance-order">
                                <input id="online" name="payment" type="radio" className="form-check-input" checked={props.t_data.payment == "Online Payment"} onClick={() => { props.t_data.payment = "Online Payment"; props.setData(props.t_data); props.setUse(!props.use); }} />
